...
class BarChartWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(
      () => Container(
        height: Get.find<HomeController>().isfullScreenBarChart.value ? double.infinity : 400,
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                Get.find<HomeController>().isfullScreenBarChart.value
                    ? IconButton(
                        ...
                        onSelected: (String value) {
                          switch (value) {
                            ...
                            case 'fullscreen':
                              ...
                              // Get.find<HomeController>().isfullScreenBarChart.value = !Get.find<HomeController>().isfullScreenBarChart.value;
...
void _showFullScreenDialog(BuildContext context, Map<String, dynamic> item) {
  ...
  showDialog(
    ...
    builder: (context) => Dialog.fullscreen(child: BarChartWidget(item: item)),
  );
}
